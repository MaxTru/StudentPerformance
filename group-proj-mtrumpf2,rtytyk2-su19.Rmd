...
```{r}
add_mod3 = lm(G3 ~ school + sex + studytime + schoolsup + higher, data = student_trn)
```
...
The complex model has better test accuarcy, but the simpler model performs slightly better $LOOCV$. However, there is no big delta. So we will at first continue with our full model and later come back to the small model.
