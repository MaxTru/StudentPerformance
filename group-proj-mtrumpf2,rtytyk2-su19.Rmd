...
knitr::kable(
  x = do.call(rbind, list(
    c("Average age", mean(best_students$age), mean(worst_students$age)),
    c("Average study time", mean(best_students$studytime), mean(worst_students$studytime)),
    c("How many had a paid tuition", sum(best_students$paid == "yes"), sum(worst_students$paid == "yes")),
    c("Average health", mean(best_students$health), mean(worst_students$health)),
    c("Average drinking during the week", mean(best_students$Dalc), mean(worst_students$Dalc)),
    c("Average drinking during the weeekend", mean(best_students$Walc), mean(worst_students$Walc)),
    c("Average family relationship", mean(best_students$famrel), mean(worst_students$famrel)),
    c("Average free time", mean(best_students$freetime), mean(worst_students$freetime))
  )),
...
We observe that best students are on average younger, study more and drink less, they also tend to have less free time and report worse health. 
