...
We will remove these ``r sum(int_mod_large_BIC)`` observations.
...
For this model, the removal of unusual observations led to a performance increase.
...
results_df = rbind(
  ...
  "Large (excl. G1 and G2) additive model without unusual observations" = c(accuracy(int_mod_large_BIC_cleaned), loocv_rmse(int_mod_large_BIC_cleaned)),
